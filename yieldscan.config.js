...
export const networks = [
	{
		...
		collectionAddress: process.env.NEXT_PUBLIC_POLKADOT_MULTISIG_COLLECTION_ADDRESS,
		commissionRatio: parseFloat(process.env.NEXT_PUBLIC_YIELDSCAN_COMMISSION_RATIO),
		erasPerDay: 1,
		lockUpPeriod: 28,
		minAmount: 1,
	...
	},
	{
		...
		collectionAddress: process.env.NEXT_PUBLIC_KUSAMA_MULTISIG_COLLECTION_ADDRESS,
		commissionRatio: parseFloat(process.env.NEXT_PUBLIC_YIELDSCAN_COMMISSION_RATIO),
		erasPerDay: 4,
		lockUpPeriod: 7,
		minAmount: 0.1,
	...
	},
	{
		...
		collectionAddress: process.env.NEXT_PUBLIC_WESTEND_MULTISIG_COLLECTION_ADDRESS,
		commissionRatio: parseFloat(process.env.NEXT_PUBLIC_YIELDSCAN_COMMISSION_RATIO),
		erasPerDay: 4,
		lockUpPeriod: 7,
		minAmount: 0.1,
