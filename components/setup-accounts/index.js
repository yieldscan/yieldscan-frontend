			...
			<div className="w-full max-w-65-rem flex flex-col items-center">
				...
				<div className="flex-1 flex flex-col text-gray-700 justify-center content-center p-2 items-center text-gray-700 space-y-6 max-w-md mb-32">
					...
					<p className="text-gray-600 text-sm text-center max-w-md">
						Just answer a few questions and we’ll get you set up. You only need
						to do this once and it will only take 2-5 minutes.
					</p>
					<div className="w-full text-center">
						<button
							className="rounded-lg font-medium px-12 py-3 bg-teal-500 text-white"
							// onClick={() => onConfirm()}
						>
							Get Started
						</button>
