const PrivacyComponent = () => (
	<div>
		<h1 className="text-3xl font-bold mt-8 mb-3" id="privacy-policy-for-yieldscan-onrender-com">
			Privacy Policy for yieldscan.onrender.com
		</h1>
		<p className="mb-4">
			At YieldScan, accessible from{" "}
			<a className="underline" href="https://yieldscan.app">https://yieldscan.app</a>, one of our main
		...
		<h1 className="text-xl font-bold mt-8 mb-3" id="consent">Consent</h1>
		<p className="mb-4">
			By using our website, you hereby consent to our Privacy Policy and agree
			to its terms.
		</p>
		<h1 className="text-xl font-bold mt-8 mb-3" id="information-we-collect">Information we collect</h1>
		<p className="mb-4">
		...
		<h1 className="text-xl font-bold mt-8 mb-3" id="how-we-use-your-information">How we use your information</h1>
		...
		<ul className="list-outside list-disc pl-5 my-4">
			...
			<li className="mb-2">
				...
				purposes if you opt in for the same
			</li>
			<li className="mb-2">Send you emails</li>
			<li className="mb-2">Find and prevent fraud</li>
		</ul>
		<h1 className="text-xl font-bold mt-8 mb-3" id="log-files">Log Files</h1>
		<p className="mb-4">
		...
		<h1 className="text-xl font-bold mt-8 mb-3" id="cookies-and-web-beacons">Cookies and Web Beacons</h1>
		<p className="mb-4">
		...
		<p className="mb-4">
			...
			<a className="underline" href="https://www.cookieconsent.com/what-are-cookies/">
				&quot;What Are Cookies&quot;
			</a>
			.
		</p>
		<h1 className="text-xl font-bold mt-8 mb-3" id="ccpa-privacy-rights">CCPA Privacy Rights</h1>
		<p className="mb-4">
		...
		<p className="mb-4">
			Please note that we do not sell any personal data. If you make a request,
			we have one month to respond to you. If you would like to exercise any of
			these rights, please contact us.
		</p>
		<h1 className="text-xl font-bold mt-8 mb-3" id="gdpr-data-protection-rights">GDPR Data Protection Rights</h1>
		<p className="mb-4">
		...
		<h1 className="text-xl font-bold mt-8 mb-3" id="children-s-information">Children&#39;s Information</h1>
		<p className="mb-4">
		...
		<p className="mb-4">
			YieldScan does not knowingly collect any Personal Identifiable Information
