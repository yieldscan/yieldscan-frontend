...
const TermsComponent = () => (
	<React.Fragment>
		...
		<p className="mb-4">
			...
			their respective owners. Nothing in these Terms of Service grants you any
		...
		<p className="mb-4">
			...
			anyone other than an authorized YieldScan spokesperson speaking in his/her
			official capacity. Please refer to the specific editorial policies posted
