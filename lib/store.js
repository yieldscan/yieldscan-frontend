...
const useSourcePage = create((set) => ({
	sourcePage: null,
	setSourcePage: (sourcePage) => set(() => ({ sourcePage })),
}));
...
const useStakingPath = create((set) => ({
	stakingPath: null,

	setStakingPath: (stakingPath) => set(() => ({ stakingPath })),
}));
...
const useWalletConnectState = create((set) => ({
	walletConnectState: null,

	setWalletConnectState: (walletConnectState) =>
		set(() => ({ walletConnectState })),
}));
...
const useIsExistingUser = create((set) => ({
	isExistingUser: null,
	setIsExistingUser: (isExistingUser) => set(() => ({ isExistingUser })),
}));

const useHasSubscription = create((set) => ({
